...
export function Features() {
    return (
        <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[120px]">
            <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
                <Image src={Feature1} alt='Feature 1 image' className='hidden w-1/2 sm:block' />
                <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
                    <h3 className="font-medium text-[#0085FF] lg:-[18px]">Sales Monitoring</h3>
                    ...
                    <ul className='flex flex-col gap-y-3 lg:text-[18px]'>
                        <li className='flex items-center gap-x-2 text-[#36485C]'>
                            <span><Image src={Check} alt='Checmark' /></span>
                        ...
                        <li className='flex items-center gap-x-2 text-[#36485C]'>
                            <span><Image src={Check} alt='Checmark' /></span>
                            Set do eiusmod tempor incididunt ut labore
                        </li>
                    </ul>
            ...
            <div className="flex flex-col gap-x-6 sm:flex-row">
                ...
                <div className='sm:w-1/2 lg:py-[56px] lg:pl-[56px]'>
                    <h3 className="font-medium text-[#00A424] lg:-[18px]">Customer Support</h3>
            ...
            <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
                ...
                <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
                    <h3 className="font-medium text-[#EB2891] lg:-[18px]">Growth Monitoring</h3>
                    <h1 className="pt-[12px] text-2xl font-medium text-[#172026] lg:text-[42px] lg:leading-[58px]">Monitor your site's mew subscribers</h1>
